...
must equal `package.json.version`; change both release notes and metadata in one commit.
...
- Authoritative generated manifest, scope justifications and Free/Pro license example.
...
- Manifest title and description now describe the transport-neutral reference app.
